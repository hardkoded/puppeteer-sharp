...
namespace PuppeteerSharp.Tests.PageTests
{
    ...
    {
        [Test, PuppeteerTimeout, PuppeteerTest("page.spec", "Page Page.waitForRequest", "should work")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("page.spec", "Page Page.waitForRequest", "should work with predicate")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("page.spec", "Page Page.waitForRequest", "should respect timeout")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("page.spec", "Page Page.waitForRequest", "should respect default timeout")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("page.spec", "Page Page.waitForRequest", "should work with no timeout")]

...
namespace PuppeteerSharp.Tests.PageTests
{
    public class WaitForResponseTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("page.spec.ts", "Page.waitForResponse", "should work")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec.ts", "Page.waitForResponse", "should work with predicate")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec.ts", "Page.waitForResponse", "should work with async predicate")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec.ts", "Page.waitForResponse", "should respect timeout")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec.ts", "Page.waitForResponse", "should respect default timeout")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec.ts", "Page.waitForResponse", "should work with no timeout")]
        [PuppeteerTimeout]

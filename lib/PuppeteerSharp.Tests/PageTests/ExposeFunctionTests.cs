...
namespace PuppeteerSharp.Tests.PageTests
{
    public class ExposeFunctionTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("page.spec", "Page.exposeFunction", "should work")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.exposeFunction", "should throw exception in page context")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.exposeFunction", "should be callable from-inside evaluateOnNewDocument")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.exposeFunction", "should await returned promise")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.exposeFunction", "should work on frames")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.exposeFunction", "should work on frames before navigation")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.exposeFunction", "should work with complex objects")]

...
namespace PuppeteerSharp.Tests.PageTests
{
    public class PageEventsPopupTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("page.spec.ts", "Page.Events.Popup", "should work")]
        ...
        [Test, PuppeteerTest("page.spec.ts", "Page.Events.Popup", "should work with noopener")]
        ...
        [Test, PuppeteerTest("page.spec.ts", "Page.Events.Popup", "should work with clicking target=_blank and without rel=opener")]
        ...
        [Test, PuppeteerTest("page.spec.ts", "Page.Events.Popup", "should work with clicking target=_blank and with rel=opener")]
        ...
        [Test, PuppeteerTest("page.spec.ts", "Page.Events.Popup", "should work with fake-clicking target=_blank and rel=noopener")]
        ...
        [Test, PuppeteerTest("page.spec.ts", "Page.Events.Popup", "should work with clicking target=_blank and rel=noopener")]

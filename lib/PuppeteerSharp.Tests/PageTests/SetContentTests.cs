...
namespace PuppeteerSharp.Tests.PageTests
{
    public class SetContentTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("page.spec", "Page.setContent", "should work")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.setContent", "should work with doctype")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.setContent", "should work with HTML 4 doctype")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.setContent", "should respect timeout")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.setContent", "should respect default navigation timeout")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.setContent", "should await resources to load")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.setContent", "should work fast enough")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.setContent", "should work with tricky content")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.setContent", "should work with accents")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.setContent", "should work with emojis")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.setContent", "should work with newline")]
        [PuppeteerTimeout]

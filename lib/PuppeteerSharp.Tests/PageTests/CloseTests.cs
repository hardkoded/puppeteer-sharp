...
namespace PuppeteerSharp.Tests.PageTests
{
    public class CloseTests : PuppeteerPageBaseTest
    {
        ...
        // [Test, PuppeteerTest("page.spec", "Page.close", "should reject all promises when page is closed")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.close", "should not be visible in browser.pages")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.close", "should run beforeunload if asked for")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.close", "should *not* run beforeunload by default")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.close", "should set the page close state")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.close", "should terminate network waiters")]

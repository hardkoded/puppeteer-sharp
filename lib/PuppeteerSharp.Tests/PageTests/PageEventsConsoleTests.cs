...
namespace PuppeteerSharp.Tests.PageTests.Events
{
    public class PageEventsConsoleTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("page.spec", "Page.Events.Console", "should work")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.Events.Console", "should work for different console API calls")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.Events.Console", "should not fail for window object")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.Events.Console", "should trigger correct Log")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.Events.Console", "should have location when fetch fails")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.Events.Console", "should have location and stack trace for console API calls")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.Events.Console", "should not throw when there are console messages in detached iframes")]

...
namespace PuppeteerSharp.Tests.PageTests.Events
{
    public class PageEventsConsoleTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("page.spec", "Page Page.Events.Console", "should work")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("page.spec", "Page Page.Events.Console", "should not fail for window object")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("page.spec", "Page Page.Events.Console", "should trigger correct Log")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("page.spec", "Page Page.Events.Console", "should have location when fetch fails")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("page.spec", "Page Page.Events.Console", "should have location and stack trace for console API calls")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("page.spec", "Page Page.Events.Console", "should not throw when there are console messages in detached iframes")]

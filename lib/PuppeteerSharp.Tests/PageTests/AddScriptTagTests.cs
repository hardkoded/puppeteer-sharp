...
namespace PuppeteerSharp.Tests.PageTests
{
    public class AddScriptTagTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("page.spec", "Page.addScriptTag", "should throw an error if no options are provided")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.addScriptTag", "should work with a url")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.addScriptTag", "should work with a url and type=module")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.addScriptTag", "should work with a path and type=module")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.addScriptTag", "should work with a content and type=module")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.addScriptTag", "should throw an error if loading from url fail")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.addScriptTag", "should work with a path")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.addScriptTag", "should include sourcemap when path is provided")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.addScriptTag", "should work with content")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.addScriptTag", "should add id when provided")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.addScriptTag", "should throw when added with content to the CSP page")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.addScriptTag", "should throw when added with URL to the CSP page")]
        [PuppeteerTimeout]

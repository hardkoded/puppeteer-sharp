...
namespace PuppeteerSharp.Tests.PageTests
{
    public class WaitForNetworkIdleTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.waitForNetworkIdle", "should work")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.waitForNetworkIdle", "should respect timeout")]
        ...
        // PRs are welcome :)
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.waitForNetworkIdle", "should respect idleTime")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.waitForNetworkIdle", "should work with no timeout")]

...
namespace PuppeteerSharp.Tests.PageTests
{
    public class SelectTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.select", "should select single option")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.select", "should select only first option")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.select", "should not throw when select causes navigation")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.select", "should select multiple options")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.select", "should respect event bubbling")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.select", "should throw when element is not a <select>")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.select", "should return [] on no matched values")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.select", "should return an array of matched values")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.select", "should return an array of one element when multiple is not set")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.select", "should return [] on no values")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.select", "should deselect all options when passed no values for a multiple select")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.select", "should deselect all options when passed no values for a select without multiple")]

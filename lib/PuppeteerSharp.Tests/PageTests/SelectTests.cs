...
namespace PuppeteerSharp.Tests.PageTests
{
    public class SelectTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("page.spec", "Page.select", "should select single option")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.select", "should select only first option")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.select", "should not throw when select causes navigation")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.select", "should select multiple options")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.select", "should respect event bubbling")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.select", "should throw when element is not a <select>")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.select", "should return [] on no matched values")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.select", "should return an array of matched values")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.select", "should return an array of one element when multiple is not set")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.select", "should return [] on no values")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.select", "should deselect all options when passed no values for a multiple select")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.select", "should deselect all options when passed no values for a select without multiple")]
        [PuppeteerTimeout]

...
namespace PuppeteerSharp.Tests.PageTests
{
    public class SetBypassCSPTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("page.spec", "Page.setBypassCSP", "should bypass CSP meta tag")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.setBypassCSP", "should bypass CSP header")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.setBypassCSP", "should bypass after cross-process navigation")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.setBypassCSP", "should bypass CSP in iframes as well")]

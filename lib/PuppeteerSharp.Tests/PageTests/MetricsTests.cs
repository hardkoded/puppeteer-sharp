...
namespace PuppeteerSharp.Tests.PageTests
{
    public class MetricsTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("page.spec", "Page Page.metrics", "should get metrics from a page")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("page.spec", "Page Page.metrics", "metrics event fired on console.timeStamp")]

...
namespace PuppeteerSharp.Tests.PageTests
{
    public class SetUserAgentTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("page.spec", "Page Page.setUserAgent", "should work")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("page.spec", "Page Page.setUserAgent", "should work for subframes")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("page.spec", "Page Page.setUserAgent", "should emulate device user-agent")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("page.spec", "Page Page.setUserAgent", "should work with additional userAgentMetdata")]

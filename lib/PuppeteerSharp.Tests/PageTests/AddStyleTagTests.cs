...
namespace PuppeteerSharp.Tests.PageTests
{
    public class AddStyleTagTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.addStyleTag", "should throw an error if no options are provided")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.addStyleTag", "should work with a url")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.addStyleTag", "should throw an error if loading from url fail")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.addStyleTag", "should work with a path")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.addStyleTag", "should include sourcemap when path is provided")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.addStyleTag", "should work with content")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.addStyleTag", "should throw when added with content to the CSP page")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("page.spec", "Page Page.addStyleTag", "should throw when added with URL to the CSP page")]

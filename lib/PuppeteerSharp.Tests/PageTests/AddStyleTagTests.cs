...
namespace PuppeteerSharp.Tests.PageTests
{
    public class AddStyleTagTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("page.spec", "Page.addStyleTag", "should throw an error if no options are provided")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.addStyleTag", "should work with a url")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.addStyleTag", "should throw an error if loading from url fail")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.addStyleTag", "should work with a path")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.addStyleTag", "should include sourcemap when path is provided")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.addStyleTag", "should work with content")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("page.spec", "Page.addStyleTag", "should throw when added with content to the CSP page")]
        ...
        [Test, PuppeteerTest("page.spec", "Page.addStyleTag", "should throw when added with URL to the CSP page")]
        [PuppeteerTimeout]

...
namespace PuppeteerSharp.Tests.NavigationTests
{
    public class PageGoBackTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("navigation.spec", "navigation Page.goBack", "should work")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("navigation.spec", "navigation Page.goBack", "should work with HistoryAPI")]

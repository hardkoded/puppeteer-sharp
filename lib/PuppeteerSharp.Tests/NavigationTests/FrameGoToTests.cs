...
namespace PuppeteerSharp.Tests.NavigationTests
{
    public class FrameGoToTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("navigation.spec", "navigation Frame.goto", "should navigate subframes")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("navigation.spec", "navigation Frame.goto", "should reject when frame detaches")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("navigation.spec", "navigation Frame.goto", "should return matching responses")]

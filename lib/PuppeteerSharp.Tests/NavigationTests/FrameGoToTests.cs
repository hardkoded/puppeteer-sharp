...
namespace PuppeteerSharp.Tests.NavigationTests
{
    public class FrameGoToTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("navigation.spec.ts", "Frame.goto", "should navigate subframes")]
        ...
        [Test, PuppeteerTest("navigation.spec.ts", "Frame.goto", "should reject when frame detaches")]
        ...
        [Test, PuppeteerTest("navigation.spec.ts", "Frame.goto", "should return matching responses")]

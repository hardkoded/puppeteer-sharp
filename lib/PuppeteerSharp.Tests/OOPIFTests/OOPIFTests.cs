...
namespace PuppeteerSharp.Tests.OOPIFTests
{
    public class OOPIFTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("oopif.spec.ts", "OOPIF", "should treat OOP iframes and normal iframes the same")]
        ...
        [Test, PuppeteerTest("oopif.spec.ts", "OOPIF", "should track navigations within OOP iframes")]
        ...
        [Test, PuppeteerTest("oopif.spec.ts", "OOPIF", "should support OOP iframes becoming normal iframes again")]
        [Ignore("See why this is so brittle")]
        ...
        [Test, PuppeteerTest("oopif.spec.ts", "OOPIF", "should support frames within OOP frames")]
        [Ignore("See why this is so brittle")]
        ...
        [Test, PuppeteerTest("oopif.spec.ts", "OOPIF", "should support OOP iframes getting detached")]
        [Ignore("See why this is so brittle")]
        ...
        [Test, PuppeteerTest("oopif.spec.ts", "OOPIF", "should support wait for navigation for transitions from local to OOPIF")]
        [Ignore("See why this is so brittle")]
        ...
        [Test, PuppeteerTest("oopif.spec.ts", "OOPIF", "should keep track of a frames OOP state")]
        [Ignore("See why this is so brittle")]
        ...
        [Test, PuppeteerTest("oopif.spec.ts", "OOPIF", "should support evaluating in oop iframes")]
        ...
        [Test, PuppeteerTest("oopif.spec.ts", "OOPIF", "should provide access to elements")]
        ...
        [Test, PuppeteerTest("oopif.spec.ts", "OOPIF", "should report oopif frames")]
        [Ignore("See why this is so brittle")]
        ...
        [Test, PuppeteerTest("oopif.spec.ts", "OOPIF", "should wait for inner OOPIFs")]
        [Ignore("See why this is so brittle")]
        ...
        [Test, PuppeteerTest("oopif.spec.ts", "OOPIF", "should load oopif iframes with subresources and request interception")]
        ...
        [Test, PuppeteerTest("oopif.spec.ts", "OOPIF", "should support frames within OOP iframes")]
        [Ignore("See why this is so brittle")]
        ...
        [Test, PuppeteerTest("oopif.spec.ts", "OOPIF", "clickablePoint, boundingBox, boxModel should work for elements inside OOPIFs")]
        ...
        [Test, PuppeteerTest("oopif.spec.ts", "OOPIF", "should detect existing OOPIFs when Puppeteer connects to an existing page")]
        ...
        [Test, PuppeteerTest("oopif.spec.ts", "OOPIF", "should support lazy OOP frames")]
        ...
        [Test, PuppeteerTest("oopif.spec.ts", "waitForFrame", "should resolve immediately if the frame already exists")]

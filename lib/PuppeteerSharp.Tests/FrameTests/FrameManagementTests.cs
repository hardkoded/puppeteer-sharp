...
namespace PuppeteerSharp.Tests.FrameTests
{
    public class FrameManagementTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("frame.spec.ts", "Frame Management", "should handle nested frames")]
        ...
        [Test, PuppeteerTest("frame.spec.ts", "Frame Management", "should send events when frames are manipulated dynamically")]
        ...
        [Test, PuppeteerTest("frame.spec.ts", "Frame Management", "should send \"framenavigated\" when navigating on anchor URLs")]
        ...
        [Test, PuppeteerTest("frame.spec.ts", "Frame Management", "should support url fragment")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("frame.spec.ts", "Frame Management", "should persist mainFrame on cross-process navigation")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("frame.spec.ts", "Frame Management", "should not send attach/detach events for main frame")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("frame.spec.ts", "Frame Management", "should detach child frames on navigation")]
        ...
        [Test, PuppeteerTest("frame.spec.ts", "Frame Management", "should report frame from-inside shadow DOM")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("frame.spec.ts", "Frame Management", "should report frame.name()")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("frame.spec.ts", "Frame Management", "should report frame.parent()")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("frame.spec.ts", "Frame Management", "should report different frame instance when frame re-attaches")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("frame.spec.ts", "Frame Management", "should support framesets")]

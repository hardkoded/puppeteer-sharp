...
namespace PuppeteerSharp.Tests.QuerySelectorTests
{
    ...
    {
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("queryselector.spec", "ElementHandle.$$eval", "should work")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("queryselector.spec", "ElementHandle.$$eval", "should retrieve content from subtree")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("queryselector.spec", "ElementHandle.$$eval", "should not throw in case of missing selector")]

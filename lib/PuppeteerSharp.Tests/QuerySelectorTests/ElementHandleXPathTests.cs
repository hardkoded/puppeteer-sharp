...
namespace PuppeteerSharp.Tests.ElementHandleTests
{
    public class ElementHandleXPathTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("queryselector.spec", "ElementHandle.$x", "should query existing element")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("queryselector.spec", "ElementHandle.$x", "should return null for non-existing element")]

...
namespace PuppeteerSharp.Tests.ElementHandleTests
{
    public class ElementHandleXPathTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("queryselector.spec", "ElementHandle.$x", "should query existing element")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("queryselector.spec", "ElementHandle.$x", "should return null for non-existing element")]

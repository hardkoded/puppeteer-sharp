...
namespace PuppeteerSharp.Tests.QuerySelectorTests
{
    public class PageQuerySelectorEvalTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("queryselector.spec", "Page.$eval", "should work")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("queryselector.spec", "Page.$eval", "should accept arguments")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("queryselector.spec", "Page.$eval", "should accept ElementHandles as arguments")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("queryselector.spec", "Page.$eval", "should throw error if no element is found")]

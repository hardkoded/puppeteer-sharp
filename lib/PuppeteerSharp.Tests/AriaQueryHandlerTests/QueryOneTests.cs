...
namespace PuppeteerSharp.Tests.AriaQueryHandlerTests
{
    public class QueryOneTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("ariaqueryhandler.spec", "queryOne", "should find button by role")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("ariaqueryhandler.spec", "queryOne", "should find button by name and role")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("ariaqueryhandler.spec", "queryOne", "should find first matching element")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("ariaqueryhandler.spec", "queryOne", "should find by name")]

...
namespace PuppeteerSharp.Tests.Page
{
    ...
    public class ScreenshotTests : PuppeteerBaseTest
    {
        ...
        private bool PixelMatch(string screenShotFile, Stream screenshot)
        {
            ...
            var baseImage = Image.Load(Path.Combine(PuppeteerLoaderFixture.FindParentDirectory("Screenshots"), screenShotFile));
            var compareImage = Image.Load(screenshot);

            //Just  for debugging purpose
            compareImage.Save(Path.Combine(PuppeteerLoaderFixture.FindParentDirectory("Screenshots"), "test.png"));

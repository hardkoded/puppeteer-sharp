...
namespace PuppeteerSharp.Tests.QueryHandlerTests.TextSelectorTests
{
    public class TextSelectorInPageTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("queryhandler.spec", "in Page", "should query existing element")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("queryhandler.spec", "in Page", "should return empty array for non-existing element")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("queryhandler.spec", "in Page", "should return first element")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("queryhandler.spec", "in Page", "should return multiple elements")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("queryhandler.spec", "in Page", "should pierce shadow DOM")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("queryhandler.spec", "in Page", "should query deeply nested text")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("queryhandler.spec", "in Page", "should query inputs")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("queryhandler.spec", "in Page", "should not query radio")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("queryhandler.spec", "in Page", "should query text spanning multiple elements")]

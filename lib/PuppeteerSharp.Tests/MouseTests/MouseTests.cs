...
namespace PuppeteerSharp.Tests.MouseTests
{
    public class MouseTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("mouse.spec", "Mouse", "should click the document")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("mouse.spec", "Mouse", "should resize the textarea")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("mouse.spec", "Mouse", "should select the text with mouse")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("mouse.spec", "Mouse", "should trigger hover state")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("mouse.spec", "Mouse", "should trigger hover state with removed window.Node")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("mouse.spec", "Mouse", "should set modifier keys on click")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("mouse.spec", "Mouse", "should send mouse wheel events")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("mouse.spec", "Mouse", "should tween mouse movement")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("mouse.spec", "Mouse", "should work with mobile viewports and cross process navigations")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("mouse.spec", "Mouse", "should throw if buttons are pressed incorrectly")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("mouse.spec", "Mouse", "should not throw if clicking in parallel")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("mouse.spec", "Mouse", "should reset properly")]

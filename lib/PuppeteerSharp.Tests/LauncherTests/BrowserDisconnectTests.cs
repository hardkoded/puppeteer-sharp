...
namespace PuppeteerSharp.Tests.LauncherTests
{
    ...
    {
        [Test, PuppeteerTimeout, PuppeteerTest("launcher.spec", "Launcher specs Browser.disconnect", "should reject navigation when browser closes")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("launcher.spec", "Launcher specs Browser.disconnect", "should reject waitForSelector when browser closes")]

...
namespace PuppeteerSharp.Tests.LauncherTests
{
    public class PuppeteerConnectTests : PuppeteerBrowserBaseTest
    {
        ...
        [Test, PuppeteerTest("launcher.spec", "Puppeteer.connect", "should be able to connect multiple times to the same browser")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("launcher.spec", "Puppeteer.connect", "should be able to close remote browser")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("launcher.spec", "Puppeteer.connect", "should support ignoreHTTPSErrors option")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("launcher.spec", "Puppeteer.connect", "should support targetFilter option")]
        ...
        [Test, PuppeteerTest("launcher.spec", "Puppeteer.connect", "should be able to reconnect to a disconnected browser")]
        ...
        [Test, PuppeteerTest("launcher.spec", "Puppeteer.connect", "should be able to connect to the same page simultaneously")]
        ...
        [Test, PuppeteerTest("launcher.spec", "Puppeteer.connect", "should be able to reconnect")]

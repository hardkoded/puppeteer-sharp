...
namespace PuppeteerSharp.Tests
{
    public class WontImplementTests : PuppeteerPageBaseTest
    {
        ...
        [PuppeteerTest("elementhandle.spec", "Custom queries", "should work with function shorthands")]
        [PuppeteerTest("emulation.spec", "Page.emulateMediaType", "should throw in case of bad argument")]
        [PuppeteerTest("emulation.spec", "Page.emulateMediaFeatures", "should throw in case of bad argument")]
        [PuppeteerTest("emulation.spec", "Page.emulateVisionDeficiency", "should throw for invalid vision deficiencies")]
        [PuppeteerTest("waittask.spec", "Page.waitFor", "should throw when unknown type")]
        ...
        [PuppeteerTest("page.spec", "Page.select", "should throw if passed in non-strings")]
        [PuppeteerTest("page.spec", "Page.exposeFunction", "should support throwing \"null\"")]
        [PuppeteerTest("page.spec", "Page.exposeFunction", "should work with function shorthands")]
        [PuppeteerTest("elementhandle.spec", "Custom queries", "should wait correctly with waitFor")]

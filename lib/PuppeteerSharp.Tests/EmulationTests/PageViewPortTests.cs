...
namespace PuppeteerSharp.Tests.EmulationTests
{
    public class PageViewPortTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("emulation.spec", "Emulation Page.viewport", "should get the proper viewport size")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("emulation.spec", "Emulation Page.viewport", "should support mobile emulation")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("emulation.spec", "Emulation Page.viewport", "should support touch emulation")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("emulation.spec", "Emulation Page.viewport", "should be detectable by Modernizr")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("emulation.spec", "Emulation Page.viewport", "should detect touch when applying viewport with touches")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("emulation.spec", "Emulation Page.viewport", "should support landscape emulation")]

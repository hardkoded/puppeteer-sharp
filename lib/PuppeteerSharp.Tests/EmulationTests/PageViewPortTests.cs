...
namespace PuppeteerSharp.Tests.EmulationTests
{
    public class PageViewPortTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("emulation.spec.ts", "Page.viewport", "should get the proper viewport size")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("emulation.spec.ts", "Page.viewport", "should support mobile emulation")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("emulation.spec.ts", "Page.viewport", "should support touch emulation")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("emulation.spec.ts", "Page.viewport", "should be detectable by Modernizr")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("emulation.spec.ts", "Page.viewport", "should detect touch when applying viewport with touches")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("emulation.spec.ts", "Page.viewport", "should support landscape emulation")]

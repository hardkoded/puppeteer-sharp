...
namespace PuppeteerSharp.Tests.EmulationTests
{
    public class EmulateTimezoneTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("emulation.spec", "Emulation Page.emulateTimezone", "should work")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("emulation.spec", "Emulation Page.emulateTimezone", "should throw for invalid timezone IDs")]

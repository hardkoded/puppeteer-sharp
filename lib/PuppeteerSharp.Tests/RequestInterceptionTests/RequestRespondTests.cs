...
namespace PuppeteerSharp.Tests.RequestInterceptionTests
{
    public class RequestRespondTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("requestinterception.spec.ts", "Request.respond", "should work")]
        ...
        /// </summary>
        [Test, PuppeteerTest("requestinterception.spec.ts", "Request.respond", "should work with status code 422")]
        ...
        [Test, PuppeteerTest("requestinterception.spec.ts", "Request.respond", "should redirect")]
        ...
        [Test, PuppeteerTest("requestinterception.spec.ts", "Request.respond", "should allow mocking binary responses")]
        ...
        [Test, PuppeteerTest("requestinterception.spec.ts", "Request.respond", "should stringify intercepted request response headers")]

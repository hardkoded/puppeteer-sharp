...
namespace PuppeteerSharp.Tests.RequestInterceptionTests
{
    public class RequestRespondTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("requestinterception.spec", "Request.respond", "should work")]
        ...
        /// </summary>
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("requestinterception.spec", "Request.respond", "should work with status code 422")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("requestinterception.spec", "Request.respond", "should redirect")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("requestinterception.spec", "Request.respond", "should allow mocking binary responses")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("requestinterception.spec", "Request.respond", "should stringify intercepted request response headers")]

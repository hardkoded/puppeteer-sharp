...
namespace PuppeteerSharp.Tests.InputTests
{
    public class FileChooserCancelTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("input.spec", "FileChooser.cancel", "should cancel dialog")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("input.spec", "FileChooser.cancel", "should fail when canceling file chooser twice")]

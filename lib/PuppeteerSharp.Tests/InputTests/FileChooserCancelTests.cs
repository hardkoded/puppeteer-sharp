...
namespace PuppeteerSharp.Tests.InputTests
{
    public class FileChooserCancelTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("input.spec", "input tests FileChooser.cancel", "should cancel dialog")]
        ...
        [Test, PuppeteerTest("input.spec", "input tests FileChooser.cancel", "should fail when canceling file chooser twice")]

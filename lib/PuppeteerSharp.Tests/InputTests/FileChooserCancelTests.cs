...
namespace PuppeteerSharp.Tests.InputTests
{
    public class FileChooserCancelTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("input.spec.ts", "FileChooser.cancel", "should cancel dialog")]
        ...
        [Test, PuppeteerTest("input.spec.ts", "FileChooser.cancel", "should fail when canceling file chooser twice")]

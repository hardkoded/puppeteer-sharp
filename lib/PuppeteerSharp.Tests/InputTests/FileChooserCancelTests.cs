...
namespace PuppeteerSharp.Tests.InputTests
{
    public class FileChooserCancelTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("input.spec", "FileChooser.cancel", "should cancel dialog")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("input.spec", "FileChooser.cancel", "should fail when canceling file chooser twice")]

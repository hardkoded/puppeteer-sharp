...
namespace PuppeteerSharp.Tests.InputTests
{
    public class PageWaitForFileChooserTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("input.spec.ts", "Page.waitForFileChooser", "should work when file input is attached to DOM")]
        ...
        [Test, PuppeteerTest("input.spec.ts", "Page.waitForFileChooser", "should work when file input is not attached to DOM")]
        ...
        [Test, PuppeteerTest("input.spec.ts", "Page.waitForFileChooser", "should respect timeout")]
        ...
        [Test, PuppeteerTest("input.spec.ts", "Page.waitForFileChooser", "should respect default timeout when there is no custom timeout")]
        ...
        [Test, PuppeteerTest("input.spec.ts", "Page.waitForFileChooser", "should prioritize exact timeout over default timeout")]
        ...
        [Test, PuppeteerTest("input.spec.ts", "Page.waitForFileChooser", "should work with no timeout")]
        ...
        [Test, PuppeteerTest("input.spec.ts", "Page.waitForFileChooser", "should return the same file chooser when there are many watchdogs simultaneously")]

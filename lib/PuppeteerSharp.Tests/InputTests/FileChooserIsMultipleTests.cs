...
namespace PuppeteerSharp.Tests.InputTests
{
    public class FileChooserIsMultipleTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("input.spec", "input tests FileChooser.isMultiple", "should work for single file pick")]
        ...
        [Test, PuppeteerTest("input.spec", "input tests FileChooser.isMultiple", "should work for \"multiple\"")]
        ...
        [Test, PuppeteerTest("input.spec", "input tests FileChooser.isMultiple", "should work for \"webkitdirectory\"")]

...
namespace PuppeteerSharp.Tests.InputTests
{
    public class FileChooserAcceptTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("input.spec.ts", "FileChooser.accept", "should accept single file")]
        ...
        [Test, PuppeteerTest("input.spec.ts", "FileChooser.accept", "should be able to read selected file")]
        ...
        [Test, PuppeteerTest("input.spec.ts", "FileChooser.accept", "should be able to reset selected files with empty file list")]
        ...
        [Test, PuppeteerTest("input.spec.ts", "FileChooser.accept", "should not accept multiple files for single-file input")]
        ...
        [Test, PuppeteerTest("input.spec.ts", "FileChooser.accept", "should fail for non-existent files")]
        ...
        [Test, PuppeteerTest("input.spec.ts", "FileChooser.accept", "should fail when accepting file chooser twice")]

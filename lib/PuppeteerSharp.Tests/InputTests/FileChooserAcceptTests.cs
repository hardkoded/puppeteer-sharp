...
namespace PuppeteerSharp.Tests.InputTests
{
    public class FileChooserAcceptTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("input.spec", "FileChooser.accept", "should accept single file")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("input.spec", "FileChooser.accept", "should be able to read selected file")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("input.spec", "FileChooser.accept", "should be able to reset selected files with empty file list")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("input.spec", "FileChooser.accept", "should not accept multiple files for single-file input")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("input.spec", "FileChooser.accept", "should fail for non-existent files")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("input.spec", "FileChooser.accept", "should fail when accepting file chooser twice")]

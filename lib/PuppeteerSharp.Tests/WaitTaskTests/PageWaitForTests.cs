...
namespace PuppeteerSharp.Tests.WaitForTests
{
    public class PageWaitForTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("waittask.spec", "Page.waitFor", "should wait for selector")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("waittask.spec", "Page.waitFor", "should wait for an xpath")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("waittask.spec", "Page.waitFor", "should not allow you to select an element with single slash xpath")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("waittask.spec", "Page.waitFor", "should timeout")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("waittask.spec", "Page.waitFor", "should work with multiline body")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("waittask.spec", "Page.waitFor", "should wait for predicate")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("waittask.spec", "Page.waitFor", "should wait for predicate with arguments")]

...
namespace PuppeteerSharp.Tests.NetworkTests
{
    public class PageEventRequestTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("network.spec", "network Page.Events.Request", "should fire for navigation requests")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("network.spec", "network Page.Events.Request", "should fire for iframes")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("network.spec", "network Page.Events.Request", "should fire for fetches")]

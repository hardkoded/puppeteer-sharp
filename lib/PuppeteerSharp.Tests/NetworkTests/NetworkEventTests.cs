...
namespace PuppeteerSharp.Tests.NetworkTests
{
    public class NetworkEventTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("network.spec", "network Network Events", "Page.Events.Request")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("network.spec", "network Network Events", "Page.Events.RequestServedFromCache")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("network.spec", "network Network Events", "Page.Events.Response")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("network.spec", "network Network Events", "Page.Events.RequestFailed")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("network.spec", "network Network Events", "Page.Events.RequestFinished")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("network.spec", "network Network Events", "should fire events in proper order")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("network.spec", "network Network Events", "should support redirects")]

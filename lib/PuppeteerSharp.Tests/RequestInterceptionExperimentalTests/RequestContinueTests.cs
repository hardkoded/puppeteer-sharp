...
{
    [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("requestinterception-experimental.spec", "Request.continue", "should work")]
    ...
    [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("requestinterception-experimental.spec", "Request.continue", "should amend HTTP headers")]
    ...
    [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("requestinterception-experimental.spec", "Request.continue",
    ...
    [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("requestinterception-experimental.spec", "Request.continue", "should amend method")]
    ...
    [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("requestinterception-experimental.spec", "Request.continue", "should amend post data")]

...
namespace PuppeteerSharp.Tests.EvaluationTests
{
    public class PageEvaluateOnNewDocumentTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("evaluation.spec.ts", "Page.evaluateOnNewDocument", "should evaluate before anything else on the page")]
        ...
        [Test, PuppeteerTest("evaluation.spec.ts", "Page.evaluateOnNewDocument", "should work with CSP")]

...
namespace PuppeteerSharp.Tests.AccessibilityTests
{
    ...
    {
        [Test, PuppeteerTest("accessibility.spec.ts", "Accessibility", "should work")]
        ...
        [Test, PuppeteerTest("accessibility.spec.ts", "Accessibility", "should report uninteresting nodes")]
        ...
        [Test, PuppeteerTest("accessibility.spec.ts", "Accessibility", "get snapshots while the tree is re-calculated")]
        ...
        [Test, PuppeteerTest("accessibility.spec.ts", "Accessibility", "roledescription")]
        ...
        [Test, PuppeteerTest("accessibility.spec.ts", "Accessibility", "orientation")]
        ...
        [Test, PuppeteerTest("accessibility.spec.ts", "Accessibility", "autocomplete")]
        ...
        [Test, PuppeteerTest("accessibility.spec.ts", "Accessibility", "multiselectable")]
        ...
        [Test, PuppeteerTest("accessibility.spec.ts", "Accessibility", "keyshortcuts")]
        ...
        [Test, PuppeteerTest("accessibility.spec.ts", "filtering children of leaf nodes", "should not report text nodes inside controls")]
        ...
        [Test, PuppeteerTest("accessibility.spec.ts", "filtering children of leaf nodes", "rich text editable fields should have children")]
        ...
        [Test, PuppeteerTest("accessibility.spec.ts", "filtering children of leaf nodes", "rich text editable fields with role should have children")]
        ...
        [Test, PuppeteerTest("accessibility.spec.ts", "plaintext contenteditable", "plain text field with role should not have children")]
        ...
        [Test, PuppeteerTest("accessibility.spec.ts", "plaintext contenteditable", "plain text field with tabindex and without role should not have content")]
        ...
        [Test, PuppeteerTest("accessibility.spec.ts", "filtering children of leaf nodes", "non editable textbox with role and tabIndex and label should not have children")]
        ...
        [Test, PuppeteerTest("accessibility.spec.ts", "filtering children of leaf nodes", "checkbox with and tabIndex and label should not have children")]
        ...
        [Test, PuppeteerTest("accessibility.spec.ts", "filtering children of leaf nodes", "checkbox without label should not have children")]

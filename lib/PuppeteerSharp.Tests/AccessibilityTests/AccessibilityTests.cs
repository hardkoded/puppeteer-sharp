...
namespace PuppeteerSharp.Tests.AccessibilityTests
{
    ...
    {
        [Test, PuppeteerTimeout, PuppeteerTest("accessibility.spec", "Accessibility", "should work")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("accessibility.spec", "Accessibility", "should report uninteresting nodes")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("accessibility.spec", "Accessibility", "get snapshots while the tree is re-calculated")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("accessibility.spec", "Accessibility", "roledescription")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("accessibility.spec", "Accessibility", "orientation")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("accessibility.spec", "Accessibility", "autocomplete")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("accessibility.spec", "Accessibility", "multiselectable")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("accessibility.spec", "Accessibility", "keyshortcuts")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("accessibility.spec", "filtering children of leaf nodes", "should not report text nodes inside controls")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("accessibility.spec", "filtering children of leaf nodes", "rich text editable fields should have children")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("accessibility.spec", "filtering children of leaf nodes", "rich text editable fields with role should have children")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("accessibility.spec", "plaintext contenteditable", "plain text field with role should not have children")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("accessibility.spec", "plaintext contenteditable", "plain text field with tabindex and without role should not have content")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("accessibility.spec", "filtering children of leaf nodes", "non editable textbox with role and tabIndex and label should not have children")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("accessibility.spec", "filtering children of leaf nodes", "checkbox with and tabIndex and label should not have children")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("accessibility.spec", "filtering children of leaf nodes", "checkbox without label should not have children")]

...
namespace PuppeteerSharp.Tests.AccessibilityTests
{
    ...
    {
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("accessibility.spec", "root option", "should work a button")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("accessibility.spec", "root option", "should work an input")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("accessibility.spec", "root option", "should work a menu")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("accessibility.spec", "root option", "should return null when the element is no longer in DOM")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("accessibility.spec", "root option", "should support the interestingOnly option")]

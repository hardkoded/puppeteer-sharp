...
namespace PuppeteerSharp.Tests.CoverageTests
{
    public class JSCoverageTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("coverage.spec", "Coverage specs JSCoverage", "should work")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("coverage.spec", "Coverage specs JSCoverage", "should report sourceURLs")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("coverage.spec", "Coverage specs JSCoverage", "should ignore eval() scripts by default")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("coverage.spec", "Coverage specs JSCoverage", "should not ignore eval() scripts if reportAnonymousScripts is true")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("coverage.spec", "Coverage specs JSCoverage", "should ignore pptr internal scripts if reportAnonymousScripts is true")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("coverage.spec", "Coverage specs JSCoverage", "should report multiple scripts")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("coverage.spec", "Coverage specs JSCoverage", "should report right ranges")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("coverage.spec", "Coverage specs JSCoverage", "should report scripts that have no coverage")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("coverage.spec", "Coverage specs JSCoverage", "should work with conditionals")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("coverage.spec", "Coverage specs JSCoverage", "should not hang when there is a debugger statement")]

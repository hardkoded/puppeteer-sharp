...
namespace PuppeteerSharp.Tests.CoverageTests
{
    public class CSSCoverageTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("coverage.spec", "Coverage specs CSSCoverage", "should work")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("coverage.spec", "Coverage specs CSSCoverage", "should report sourceURLs")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("coverage.spec", "Coverage specs CSSCoverage", "should report multiple stylesheets")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("coverage.spec", "Coverage specs CSSCoverage", "should report stylesheets that have no coverage")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("coverage.spec", "Coverage specs CSSCoverage", "should work with media queries")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("coverage.spec", "Coverage specs CSSCoverage", "should work with complicated usecases")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("coverage.spec", "Coverage specs CSSCoverage", "should ignore injected stylesheets")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("coverage.spec", "Coverage specs CSSCoverage", "should work with a recently loaded stylesheet")]

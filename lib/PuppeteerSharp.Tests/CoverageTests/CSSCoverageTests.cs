...
namespace PuppeteerSharp.Tests.CoverageTests
{
    public class CSSCoverageTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("coverage.spec", "Coverage specs CSSCoverage", "should work")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("coverage.spec", "Coverage specs CSSCoverage", "should report sourceURLs")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("coverage.spec", "Coverage specs CSSCoverage", "should report multiple stylesheets")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("coverage.spec", "Coverage specs CSSCoverage", "should report stylesheets that have no coverage")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("coverage.spec", "Coverage specs CSSCoverage", "should work with media queries")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("coverage.spec", "Coverage specs CSSCoverage", "should work with complicated usecases")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("coverage.spec", "Coverage specs CSSCoverage", "should ignore injected stylesheets")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("coverage.spec", "Coverage specs CSSCoverage", "should work with a recently loaded stylesheet")]

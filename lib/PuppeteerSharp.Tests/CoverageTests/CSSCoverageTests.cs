...
namespace PuppeteerSharp.Tests.CoverageTests
{
    public class CSSCoverageTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("coverage.spec", "CSSCoverage", "should work")]
        ...
        [Test, PuppeteerTest("coverage.spec", "CSSCoverage", "should report sourceURLs")]
        ...
        [Test, PuppeteerTest("coverage.spec", "CSSCoverage", "should report multiple stylesheets")]
        ...
        [Test, PuppeteerTest("coverage.spec", "CSSCoverage", "should report stylesheets that have no coverage")]
        ...
        [Test, PuppeteerTest("coverage.spec", "CSSCoverage", "should work with media queries")]
        ...
        [Test, PuppeteerTest("coverage.spec", "CSSCoverage", "should work with complicated usecases")]
        ...
        [Test, PuppeteerTest("coverage.spec", "CSSCoverage", "should ignore injected stylesheets")]
        ...
        [Test, PuppeteerTest("coverage.spec", "CSSCoverage", "should work with a recently loaded stylesheet")]

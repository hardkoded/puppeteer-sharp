    ...
    public class FirefoxDataTests
    {
        ...
        public void ShouldResolveDownloadUrls()
        {
            Assert.That(
                ...
                Is.EqualTo("https://archive.mozilla.org/pub/firefox/releases/111.0a1/linux-x86_64/en-US/firefox-111.0a1.tar.bz2"));
            Assert.That(
                BrowserData.Firefox.ResolveDownloadUrl(Platform.MacOS, "111.0a1", null),
                Is.EqualTo("https://archive.mozilla.org/pub/firefox/releases/111.0a1/mac/en-US/Firefox 111.0a1.dmg"));
            Assert.That(
            ...
            Assert.That(
                ...
                Is.EqualTo("https://archive.mozilla.org/pub/firefox/releases/111.0a1/win32/en-US/Firefox Setup 111.0a1.exe"));
            Assert.That(
                BrowserData.Firefox.ResolveDownloadUrl(Platform.Win64, "111.0a1", null),
                Is.EqualTo("https://archive.mozilla.org/pub/firefox/releases/111.0a1/win64/en-US/Firefox Setup 111.0a1.exe"));
        }

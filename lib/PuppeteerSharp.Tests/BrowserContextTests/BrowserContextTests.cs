...
namespace PuppeteerSharp.Tests.BrowserContextTests
{
    ...
    {
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("browsercontext.spec", "BrowserContext", "should have default context")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("browsercontext.spec", "BrowserContext", "should create new incognito context")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("browsercontext.spec", "BrowserContext", "should close all belonging targets once closing context")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("browsercontext.spec", "BrowserContext", "window.open should use parent tab context")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("browsercontext.spec", "BrowserContext", "should fire target events")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("browsercontext.spec", "BrowserContext", "should isolate localStorage and cookies")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("browsercontext.spec", "BrowserContext", "should work across sessions")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("browsercontext.spec", "BrowserContext", "should provide a context id")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("browsercontext.spec", "BrowserContext", "should wait for a target")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("browsercontext.spec", "BrowserContext", "should timeout waiting for a non-existent target")]

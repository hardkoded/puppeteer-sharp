...
namespace PuppeteerSharp.Tests.InjectedTests
{
    public class InjectedTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("injected.spec", "PuppeteerUtil tests", "should work")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("injected.spec", "createFunction tests", "should work")]

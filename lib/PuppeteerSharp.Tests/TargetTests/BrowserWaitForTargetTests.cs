...
namespace PuppeteerSharp.Tests.TargetTests
{
    public class BrowserWaitForTargetTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("target.spec.ts", "Browser.waitForTarget", "should wait for a target")]
        ...
        [Test, PuppeteerTest("target.spec.ts", "Browser.waitForTarget", "should timeout waiting for a non-existent target")]

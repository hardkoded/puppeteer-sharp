...
namespace PuppeteerSharp.Tests.TargetTests
{
    public class BrowserWaitForTargetTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("target.spec", "Browser.waitForTarget", "should wait for a target")]
        ...
        [Test, PuppeteerTest("target.spec", "Browser.waitForTarget", "should timeout waiting for a non-existent target")]

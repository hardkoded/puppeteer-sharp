...
namespace PuppeteerSharp.Tests.TargetTests
{
    public class TargetTests : PuppeteerPageBaseTest
    {
        ...
        [Test, Retry(2), PuppeteerTest("target.spec", "Target Target", "Browser.targets should return all of the targets")]
        ...
        [Test, Retry(2), PuppeteerTest("target.spec", "Target Target", "Browser.pages should return all of the pages")]
        ...
        [Test, Retry(2), PuppeteerTest("target.spec", "Target Target", "should contain browser target")]
        ...
        [Test, Retry(2), PuppeteerTest("target.spec", "Target Target", "should be able to use the default page in the browser")]
        ...
        [Test, Retry(2), PuppeteerTest("target.spec", "Target Target", "should report when a new page is created and closed")]
        ...
        [Test, Retry(2), PuppeteerTest("target.spec", "Target Target", "should report when a service worker is created and destroyed")]
        ...
        [Test, Retry(2), PuppeteerTest("target.spec", "Target Target", "should create a worker from a service worker")]
        ...
        [Test, Retry(2), PuppeteerTest("target.spec", "Target Target", "should create a worker from a shared worker")]
        ...
        [Test, Retry(2), PuppeteerTest("target.spec", "Target Target", "should report when a target url changes")]
        ...
        [Test, Retry(2), PuppeteerTest("target.spec", "Target Target", "should not report uninitialized pages")]
        ...
        [Test, Retry(2), PuppeteerTest("target.spec", "Target Target", "should not crash while redirecting if original request was missed")]
        ...
        [Test, Retry(2), PuppeteerTest("target.spec", "Target Target", "should have an opener")]

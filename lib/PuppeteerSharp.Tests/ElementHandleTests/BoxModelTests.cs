...
namespace PuppeteerSharp.Tests.ElementHandleTests
{
    public class BoxModelTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("elementhandle.spec.ts", "ElementHandle.boxModel", "should work")]
        ...
        [Test, PuppeteerTest("elementhandle.spec.ts", "ElementHandle.boxModel", "should return null for invisible elements")]

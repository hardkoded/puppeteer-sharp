...
namespace PuppeteerSharp.Tests.ElementHandleTests
{
    public class BoundingBoxTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("elementhandle.spec", "ElementHandle.boundingBox", "should work")]
        ...
        [Test, PuppeteerTest("elementhandle.spec", "ElementHandle.boundingBox", "should handle nested frames")]
        ...
        [Test, PuppeteerTest("elementhandle.spec", "ElementHandle.boundingBox", "should return null for invisible elements")]
        ...
        [Test, PuppeteerTest("elementhandle.spec", "ElementHandle.boundingBox", "should force a layout")]
        ...
        [Test, PuppeteerTest("elementhandle.spec", "ElementHandle.boundingBox", "should work with SVG nodes")]

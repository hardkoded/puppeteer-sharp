...
namespace PuppeteerSharp.Tests.ElementHandleTests
{
    public class BoundingBoxTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("elementhandle.spec.ts", "ElementHandle.boundingBox", "should work")]
        ...
        [Test, PuppeteerTest("elementhandle.spec.ts", "ElementHandle.boundingBox", "should handle nested frames")]
        ...
        [Test, PuppeteerTest("elementhandle.spec.ts", "ElementHandle.boundingBox", "should return null for invisible elements")]
        ...
        [Test, PuppeteerTest("elementhandle.spec.ts", "ElementHandle.boundingBox", "should force a layout")]
        ...
        [Test, PuppeteerTest("elementhandle.spec.ts", "ElementHandle.boundingBox", "should work with SVG nodes")]

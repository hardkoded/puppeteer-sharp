...
namespace PuppeteerSharp.Tests.JSHandleTests
{
    public class ClickablePointTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("jshandle.spec.ts", "JSHandle.clickablePoint", "should work")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("jshandle.spec.ts", "JSHandle.clickablePoint", "should work for iframes")]
        [PuppeteerTimeout]

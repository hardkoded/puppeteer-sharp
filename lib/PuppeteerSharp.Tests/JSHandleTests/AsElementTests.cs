...
namespace PuppeteerSharp.Tests.JSHandleTests
{
    public class AsElementTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("jshandle.spec", "JSHandle JSHandle.asElement", "should work")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("jshandle.spec", "JSHandle JSHandle.asElement", "should return null for non-elements")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("jshandle.spec", "JSHandle JSHandle.asElement", "should return ElementHandle for TextNodes")]

...
namespace PuppeteerSharp.Tests.JSHandleTests
{
    public class ToStringTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("jshandle.spec.ts", "JSHandle.toString", "should work for primitives")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("jshandle.spec.ts", "JSHandle.toString", "should work for complicated objects")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("jshandle.spec.ts", "JSHandle.toString", "should work with different subtypes")]
        [PuppeteerTimeout]

...
namespace PuppeteerSharp.Tests.DragAndDropTests
{
    public class DragAndDropTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("drag-and-drop.spec.ts", "Drag n' Drop", "should drop")]
        ...
        [Test, PuppeteerTest("drag-and-drop.spec.ts", "Drag n' Drop", "should drop using mouse")]
        ...
        [Test, PuppeteerTest("drag-and-drop.spec.ts", "Drag n' Drop", "should drag and drop")]

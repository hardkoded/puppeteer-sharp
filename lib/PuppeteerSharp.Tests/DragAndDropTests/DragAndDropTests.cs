...
namespace PuppeteerSharp.Tests.DragAndDropTests
{
    public class DragAndDropTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("drag-and-drop.spec", "Drag n' Drop", "should drop")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("drag-and-drop.spec", "Drag n' Drop", "should drop using mouse")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("drag-and-drop.spec", "Drag n' Drop", "should drag and drop")]

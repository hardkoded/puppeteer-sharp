...
namespace PuppeteerSharp.Tests.DragAndDropTests
{
    public class LegacyDragAndDropTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("drag-and-drop.spec.ts", "Legacy Drag n' Drop", "should emit a dragIntercepted event when dragged")]
        ...
        [Test, PuppeteerTest("drag-and-drop.spec.ts", "Legacy Drag n' Drop", "should emit a dragEnter")]
        ...
        [Test, PuppeteerTest("drag-and-drop.spec.ts", "Legacy Drag n' Drop", "should emit a dragOver event")]
        ...
        [Test, PuppeteerTest("drag-and-drop.spec.ts", "Legacy Drag n' Drop", "can be dropped")]
        ...
        [Test, PuppeteerTest("drag-and-drop.spec.ts", "Legacy Drag n' Drop", "can be dragged and dropped with a single function")]

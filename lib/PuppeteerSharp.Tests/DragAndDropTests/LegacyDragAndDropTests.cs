...
namespace PuppeteerSharp.Tests.DragAndDropTests
{
    public class LegacyDragAndDropTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("drag-and-drop.spec", "Legacy Drag n' Drop", "should emit a dragIntercepted event when dragged")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("drag-and-drop.spec", "Legacy Drag n' Drop", "should emit a dragEnter")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("drag-and-drop.spec", "Legacy Drag n' Drop", "should emit a dragOver event")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("drag-and-drop.spec", "Legacy Drag n' Drop", "can be dropped")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("drag-and-drop.spec", "Legacy Drag n' Drop", "can be dragged and dropped with a single function")]

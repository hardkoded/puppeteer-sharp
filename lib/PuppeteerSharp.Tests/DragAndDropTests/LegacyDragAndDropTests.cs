...
namespace PuppeteerSharp.Tests.DragAndDropTests
{
    public class LegacyDragAndDropTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("drag-and-drop.spec", "Legacy Drag n' Drop", "should emit a dragIntercepted event when dragged")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("drag-and-drop.spec", "Legacy Drag n' Drop", "should emit a dragEnter")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("drag-and-drop.spec", "Legacy Drag n' Drop", "should emit a dragOver event")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("drag-and-drop.spec", "Legacy Drag n' Drop", "can be dropped")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("drag-and-drop.spec", "Legacy Drag n' Drop", "can be dragged and dropped with a single function")]

...
namespace PuppeteerSharp.Tests.CDPSessionTests
{
    public class CreateCDPSessionTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("CDPSession.spec", "Target.createCDPSession", "should work")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("CDPSession.spec", "Target.createCDPSession", "should send events")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("CDPSession.spec", "Target.createCDPSession", "should enable and disable domains independently")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("CDPSession.spec", "Target.createCDPSession", "should be able to detach session")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("CDPSession.spec", "Target.createCDPSession", "should not report created targets for custom CDP sessions")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("CDPSession.spec", "Target.createCDPSession", "should throw nice errors")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("CDPSession.spec", "Target.createCDPSession", "should expose the underlying connection")]

...
namespace PuppeteerSharp.Tests.DevtoolsTests
{
    public class DevtoolsTests : PuppeteerBaseTest
    {
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("devtools.spec", "DevTools", "should open devtools when \"devtools: true\" option is given")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("devtools.spec", "DevTools", "should expose DevTools as a page")]

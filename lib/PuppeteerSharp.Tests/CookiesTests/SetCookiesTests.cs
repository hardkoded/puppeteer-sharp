...
namespace PuppeteerSharp.Tests.CookiesTests
{
    public class SetCookiesTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.setCookie", "should work")]
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.setCookie", "should isolate cookies in browser contexts")]
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.setCookie", "should set multiple cookies")]
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.setCookie", "should have |expires| set to |-1| for session cookies")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.setCookie", "should set cookie with reasonable defaults")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.setCookie", "should set a cookie with a path")]
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.setCookie", "should not set a cookie on a blank page")]
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.setCookie", "should not set a cookie with blank page URL")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.setCookie", "should not set a cookie on a data URL page")]
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.setCookie", "should default to setting secure cookie for HTTPS websites")]
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.setCookie", "should be able to set insecure cookie for HTTP website")]
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.setCookie", "should be able to set unsecure cookie for HTTP website")]
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.setCookie", "should set a cookie on a different domain")]
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.setCookie", "should set cookies from a frame")]
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.setCookie", "should set secure same-site cookies from a frame")]

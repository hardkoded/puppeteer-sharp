...
namespace PuppeteerSharp.Tests.CookiesTests
{
    public class CookiesTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.cookies", "should return no cookies in pristine browser context")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.cookies", "should get a cookie")]
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.cookies", "should properly report httpOnly cookie")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.cookies", "should properly report \"Strict\" sameSite cookie")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.cookies", "should properly report \"Lax\" sameSite cookie")]
        [PuppeteerTimeout]
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.cookies", "should get multiple cookies")]
        ...
        [Test, PuppeteerTest("cookies.spec", "Page.cookies", "should get cookies from multiple urls")]

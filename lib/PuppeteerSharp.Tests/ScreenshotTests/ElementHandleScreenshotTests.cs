...
namespace PuppeteerSharp.Tests.ScreenshotTests
{
    ...
    {
        [Test, PuppeteerTimeout, PuppeteerTest("screenshot.spec", "Screenshots ElementHandle.screenshot", "should work")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("screenshot.spec", "Screenshots ElementHandle.screenshot", "should take into account padding and border")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("screenshot.spec", "Screenshots ElementHandle.screenshot", "should capture full element when larger than viewport")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("screenshot.spec", "Screenshots ElementHandle.screenshot", "should scroll element into view")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("screenshot.spec", "Screenshots ElementHandle.screenshot", "should work with a rotated element")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("screenshot.spec", "Screenshots ElementHandle.screenshot", "should fail to screenshot a detached element")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("screenshot.spec", "Screenshots ElementHandle.screenshot", "should not hang with zero width/height element")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("screenshot.spec", "Screenshots ElementHandle.screenshot", "should work for an element with fractional dimensions")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("screenshot.spec", "Screenshots ElementHandle.screenshot", "should work for an element with an offset")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("screenshot.spec", "Screenshots ElementHandle.screenshot", "should work with a null viewport")]

...
namespace PuppeteerSharp.Tests.HeadfulTests
{
    public class HeadfulTests : PuppeteerBaseTest
    {
        ...
        [Test, PuppeteerTest("headful.spec", "HEADFUL", "should open devtools when \"devtools: true\" option is given")]
        ...
        [Test, PuppeteerTest("headful.spec", "HEADFUL", "should expose DevTools as a page")]

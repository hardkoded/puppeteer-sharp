...
namespace PuppeteerSharp.Tests.HeadfulTests
{
    public class HeadfulTests : PuppeteerBaseTest
    {
        ...
        [Test, PuppeteerTest("headful.spec.ts", "HEADFUL", "background_page target type should be available")]
        ...
        [Test, PuppeteerTest("headful.spec.ts", "HEADFUL", "target.page() should return a background_page")]
        ...
        [Test, PuppeteerTest("headful.spec.ts", "HEADFUL", "should have default url when launching browser")]
        ...
        [Test, PuppeteerTest("headful.spec.ts", "HEADFUL", "headless should be able to read cookies written by headful")]
        ...
        [Test, PuppeteerTest("headful.spec.ts", "HEADFUL", "OOPIF: should report google.com frame")]
        ...
        [Test, PuppeteerTest("headful.spec.ts", "HEADFUL", "OOPIF: should expose events within OOPIFs")]
        ...
        [Test, PuppeteerTest("headful.spec.ts", "HEADFUL", "should close browser with beforeunload page")]
        ...
        [Test, PuppeteerTest("headful.spec.ts", "HEADFUL", "should open devtools when \"devtools: true\" option is given")]
        ...
        [Test, PuppeteerTest("headful.spec.ts", "HEADFUL", "should expose DevTools as a page")]

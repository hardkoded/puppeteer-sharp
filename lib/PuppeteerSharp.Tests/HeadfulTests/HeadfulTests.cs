...
namespace PuppeteerSharp.Tests.HeadfulTests
{
    public class HeadfulTests : PuppeteerBaseTest
    {
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("headful.spec", "HEADFUL", "background_page target type should be available")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("headful.spec", "HEADFUL", "target.page() should return a background_page")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("headful.spec", "HEADFUL", "should have default url when launching browser")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("headful.spec", "HEADFUL", "headless should be able to read cookies written by headful")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("headful.spec", "HEADFUL", "OOPIF: should report google.com frame")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("headful.spec", "HEADFUL", "OOPIF: should expose events within OOPIFs")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("headful.spec", "HEADFUL", "should close browser with beforeunload page")]

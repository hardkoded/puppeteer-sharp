...
{
    [Test, PuppeteerTest("prerender.spec.ts", "via frame", "can navigate to a prerendered page via input")]
    ...
    [Test, PuppeteerTest("prerender.spec.ts", "via frame", "can navigate to a prerendered page via Puppeteer")]

...
{
    [Test, PuppeteerTest("prerender.spec.ts", "Prerender", "can navigate to a prerendered page via input")]
    ...
    [Test, PuppeteerTest("prerender.spec.ts", "Prerender", "can navigate to a prerendered page via Puppeteer")]

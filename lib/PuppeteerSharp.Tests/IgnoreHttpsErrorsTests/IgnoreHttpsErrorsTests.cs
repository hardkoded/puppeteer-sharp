...
namespace PuppeteerSharp.Tests.IgnoreHttpsErrorsTests
{
    public class IgnoreHttpsErrorsTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("ignorehttpserrors.spec", "ignoreHTTPSErrors", "should work")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("ignorehttpserrors.spec", "ignoreHTTPSErrors", "should work with request interception")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("ignorehttpserrors.spec", "ignoreHTTPSErrors", "should work with mixed content")]

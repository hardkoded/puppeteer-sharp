...
namespace PuppeteerSharp.Tests.IgnoreHttpsErrorsTests
{
    public class IgnoreHttpsErrorsTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("ignorehttpserrors.spec", "ignoreHTTPSErrors", "should work")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("ignorehttpserrors.spec", "ignoreHTTPSErrors", "should work with request interception")]
        ...
        [Test, PuppeteerTimeout, Retry(2), PuppeteerTest("ignorehttpserrors.spec", "ignoreHTTPSErrors", "should work with mixed content")]

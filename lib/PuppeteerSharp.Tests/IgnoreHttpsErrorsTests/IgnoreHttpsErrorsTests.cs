...
namespace PuppeteerSharp.Tests.IgnoreHttpsErrorsTests
{
    public class IgnoreHttpsErrorsTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTest("ignorehttpserrors.spec", "ignoreHTTPSErrors", "should work")]
        ...
        [Test, PuppeteerTest("ignorehttpserrors.spec", "ignoreHTTPSErrors", "should work with request interception")]
        ...
        [Test, PuppeteerTest("ignorehttpserrors.spec", "ignoreHTTPSErrors", "should work with mixed content")]

...
namespace PuppeteerSharp.Tests.IgnoreHttpsErrorsTests
{
    public class ResponseSecurityDetailsTests : PuppeteerPageBaseTest
    {
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("ignorehttpserrors.spec", "Response.securityDetails", "Should Work")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("ignorehttpserrors.spec", "Response.securityDetails", "should be |null| for non-secure requests")]
        ...
        [Test, PuppeteerTimeout, PuppeteerTest("ignorehttpserrors.spec", "Response.securityDetails", "Network redirects should report SecurityDetails")]

                ...
                try
                {
                    switch (e.MessageID)
                    {
                        ...
                        case "Target.attachedToTarget":
                            await OnAttachedToTargetAsync(e.MessageData.Deserialize<TargetAttachedToTargetResponse>()).ConfigureAwait(false);
                            break;
                        case "Target.detachedFromTarget":
                            OnDetachedFromTarget(e.MessageData.Deserialize<TargetDetachedFromTargetResponse>());
                            break;
                        default:
                            break;
                    }
